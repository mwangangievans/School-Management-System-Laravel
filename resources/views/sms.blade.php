            ...
            <div class="row">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="mes">Send SMS message to All</h2>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="/custom">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="users[]" multiple class="form-control">
                                        ...
                                        <option class="optionstudent">{{ $user->phone}}</option>
                                        ...
                                        @endforeach
                                        <hr>
                                        @foreach ( $lectures as $user)
                                        <option class="optionlecturers">{{ $user->phone}}</option>
