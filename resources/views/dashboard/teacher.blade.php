    ...
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        ...
        <div class="w-full sm:w-1/2 ml-2 mb-6">
            ...
            <div class="flex items-center bg-pink-400 rounded-tl rounded-tr">
                <div class="w-1/3 text-left text-blue-600 py-2 px-4 font-semibold">Code</div>
                <div class="w-1/3 text-left text-blue-600 py-2 px-4 font-semibold">Subject</div>
                <div class="w-1/3 text-right text-blue-600 py-2 px-4 font-semibold">Teacher</div>
            </div>
        ...
        <div class="w-full sm:w-1/2 ml-2 mb-6">
            <h3 class="text-gray-700 uppercase font-bold mb-2">Students List</h3>
            <div class="flex items-center bg-pink-400 rounded-tl rounded-tr">
                <div class="w-1/3 text-left text-blue-600 py-2 px-4 font-semibold">name</div>
                <div class="w-1/3 text-left text-blue-600 py-2 px-4 font-semibold">phone</div>
                <div class="w-1/3 text-right text-blue-600 py-2 px-4 font-semibold">Email</div>
            </div>
            @foreach ($teacher->stud as $student)
                <div class="flex items-center justify-between border border-gray-200">
                    <div class="w-1/3 text-left text-gray-600 py-2 px-4 font-medium">{{$student->user->name}}</div>
                    <div class="w-1/3 text-left text-gray-600 py-2 px-4 font-medium">{{$student->phone}}</div>
                    <div class="w-1/3 text-right text-gray-600 py-2 px-4 font-medium">{{$student->user->email}}</div>
                </div>
            @endforeach
        </div>
    </div>
