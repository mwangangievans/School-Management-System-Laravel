        ...
        <div class="w-full sm:w-1/2 ml-2 mb-6">
         ...
         <div class="w-full sm:w-1/2 ml-2 mb-6">
            ...
            <div class="flex items-center bg-pink-400 rounded-tl rounded-tr">
                ...
                @foreach ($teacher->classes as $class)
                <div class="flex items-center justify-between border border-gray-200">
                    <div class="w-1/3 text-left text-gray-600 py-2 px-4 font-medium">{{ $class->teacher->user->name  }}</div>
                    <div class="w-1/3 text-left text-gray-600 py-2 px-4 font-medium">{{$class->teacher->user->name  }}</div>
                    <div class="w-1/3 text-right text-gray-600 py-2 px-4 font-medium">{{$class->teacher->user->name  }}</div>
                </div>
            @endforeach
        </div>
